...
extension HTML2PDFRenderer {
	...
	public func render(htmlURL: URL, toPDF pdfURL: URL, paperSize: PaperSize, paperMargins: UIEdgeInsets = .zero, delegate: HTML2PDFRendererDelegate? = nil, callback: @escaping Callback = {_, _ in}) {
		guard let window = UIApplication.shared.keyWindow, let accessURL = FileManager.default.documentsURL else {
            return
        }
	...
	public func render(webView: WKWebView, toPDF pdfURL: URL, paperSize: PaperSize, paperMargins: UIEdgeInsets = .zero, delegate: HTML2PDFRendererDelegate? = nil, callback: Callback = {_, _ in}) {
